...
let MessageSchema = mongoose.Schema(
	{
		...
		threadId: {type: mongoose.Schema.Types.ObjectId, require: 'threadId is a required field', ref: 'Thread'},
		projectId: {type: mongoose.Schema.Types.ObjectId, require: 'projectId is a required field', ref: 'Project'},
		channelId: {type: mongoose.Schema.Types.ObjectId, require: 'channelId is a required field', ref: 'Channel'},
